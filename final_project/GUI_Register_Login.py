...
class LogInterface:
    def __init__(self):
        ...
        #---- Buttons ----#
        self.login_b = tkinter.Button(self.main_window, height=2, width=5, text='Login', bg='blue', fg='blue', command=self.user_login)
        self.login_b.place(x=220, y=190)

        self.sign_up_b = tkinter.Button(self.main_window, height=2, width=7, text='Sign up', command=self.user_sign_up)
